...
\lstdefinelanguage{isabelle}{
    keywords=[1]{abbreviation,by,contractLoop,corollary,datatype,definition,done,env,evalBoudnAuction,fun,function,goal,handleChoose,handleDeposit,inputList,lemma,newstate,m,ps,qs,terms,payments,proof,record,reduce,reduced,sta,termination,theorem,theory,tra,trec,type_synonym,using,warnings,fixSta,reduceWarns,pays,curState,cont},
    morecomment=[s]{(*}{*)}, % chktex 9
    keywordstyle=[1]\bfseries\color{isarblue},
    keywords=[2]{a,and,applyWarn,assumes,begin,cont,end,imports,newState,p,shows,where},
