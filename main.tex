...
\begin{figure}
    ...
    \caption{Representación simplificada de los datos en un bloque de la cadena. Extraída de \href{https://docs.cardano.org/new-to-cardano/what-is-a-blockchain}{https://docs.cardano.org/new-to-cardano/what-is-a-blockchain}}\label{fig:Bloques}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Logo de la cadena de bloques Cardano. Extraído de \href{https://en.wikipedia.org/wiki/Cardano_(blockchain_platform)}{https://en.wikipedia.org/wiki/Cardano\_(blockchain\_platform)}}\label{fig:Cardano_logo}
\end{figure}
