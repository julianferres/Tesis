...
Cabe aclarar que una transacción puede también contener otros datos, como veremos en la sección~\ref{sec:Extended_UTXO}.
...
\subsection{El modelo UTXO extendido}\label{sec:Extended_UTXO}
