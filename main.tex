...
Finalmente, probaremos la ausencia de \textit{warnings} en el contrato \textit{Auction}. Para esto, traduciremos el contrato a Isabelle, demostraremos la terminación del mismo y algunos lemas auxiliares que nos ayudan en la prueba del teorema.
...
\subsection{Traducción del contrato Auction a Isabelle}

\subsection{Probando terminación del contrato}

% TODO: WIP

\cite{termination-isabelle}
