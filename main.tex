...
Como se menciono en~\ref{sec:Semantica_marlowe_isabelle}, no se ha desarrollado aún ningun tipo de traductor de Haskell a Isabelle/HOL.\@ Esto obligo a que se debieran traducir manualmente los contratos generados:
...
A continuación mostramos algunas ejecuciones de usando \textit{computeTransaction}, mostramos en color rojo la salida producida.
