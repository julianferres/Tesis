...
% como parametro del newtcblisting no funciona. Esto funciona para que la numeración
...
\begin{code}[title=Test propuesto por ACTUS para el contrato COM. Se pueden ovservar tanto los términos como eventos observados y los eventos que se esperá que la implementación genere.]{Haskell-Cardano}
"com04": {
        "identifier": "com04",
        "terms": {
            "contractType": "COM",
