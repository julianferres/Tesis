...
La totalidad de las pruebas de Marlowe en Isabelle se encuentran en~\cite{marlowe-isabelle-repo}, donde se pueden destacar los siguientes módulos:

\begin{itemize}
    \item SemanticsTypes
    \item Semantics
    \item MoneyPreservation
    \item PositiveAccounts
    \item QuiescentResult
    \item ValidState
    \item CloseSafe
\end{itemize}
