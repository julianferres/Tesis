...
Al terminar esta tesis, no puedo dejar de agradecer a aquellas personas que tuvieron impacto en la misma:
{ \setlength{\parindent}{24pt}

    \textit{En primer lugar deseo expresar gratidud a mi director, Dr.\ Ing. Mariano G. Beiró, por la dedicación y apoyo que ha brindado a este trabajo, por el respeto y confianza a mis sugerencias e ideas y por la guía a lo largo de esta tesis.}
    ...
    \textit{Un trabajo de investigación es siempre fruto de ideas, proyectos y esfuerzos previos. En este caso mi más sincero agradecimiento a Pablo Lamela Seijas, Yves Hauser y todo el equipo de investigación y desarrollo de IOHK, por la oportunidad y la supervisión durante los aportes de este trabajo.}
...
{ \setlength{\parindent}{24pt}
    ...
    \textit{A mis amigos, por entender mis ausencias durante los largos momentos de estudio y desarrollo de este trabajo.}
