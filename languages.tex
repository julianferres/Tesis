...
\newtcblisting[blend into = listings]{code}[2][]{%
 ...
 coltitle=black,
 overlay first app={%
   \draw[dashed,line width=0.75pt,xshift=0.75pt] (frame.south east) -- (frame.south west);%
  },
 overlay middle app={%
   \draw[dashed,line width=0.75pt,xshift=-0.75pt] (frame.north east) -- (frame.north west);
   \draw[dashed,line width=0.75pt,xshift=0.75pt] (frame.south east) -- (frame.south west);%
  },
 overlay last app={%
   \draw[dashed,line width=0.75pt,xshift=-0.75pt] (frame.north east) -- (frame.north west);
